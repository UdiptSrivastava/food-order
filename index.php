<?php 
 include("header.php"); 
      ...
      $sql=mysqli_query($con,"Select dish,price,image,sold from dish order by sold desc limit 4 ")or die('ERROR'.mysqli_error($con));
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="admin/assets/images/<?php echo $rs[2]; ?>" alt="IMG-INTRO" style="height: 100px;width: 150px"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="#"><h2 class="txt5 color0-hov trans-0-4 m-b-13">
									<?php echo $rs[0]; ?>
								</h2></a>
								...
								<p class="txt4" style="font-weight: bold">
									<?php echo "Price ".$rs[1]." Rs."; ?>
